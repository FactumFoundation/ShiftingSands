...
void setup()
{
  ...
  out = minim.getLineOut(Minim.STEREO, 2048, 88200, 16);
...
void nextFreq()
{
  ...
  {
    lowFreqAni = new Ani(this, 0.3, 7.5, "oscFreq", 2581, Ani.LINEAR, "onEnd:nextFreq"); 
  ...
  if (dice < 1)
  {
    highFreqAmpAni = new Ani(this, 3.0, "highFreqAmplitude", 100, Ani.LINEAR);
    ...
    case 1: 
       ...
       */
    default:
      randomHighFreq   = (int)random(20000, 29000);
      break;
    }
